...
<header id="global-header" class="fixed top-0 left-0 right-0 z-50">
  <div class="max-w-7xl mx-auto px-6 lg:px-10">
    <div class="flex items-center justify-between h-20 lg:h-24">
      ...
      <div class="flex items-center gap-4">
        <a href="contact.php" class="btn-luxury hidden md:inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-amber-600 to-amber-500 px-6 py-2.5 text-sm font-semibold text-white shadow-lg shadow-amber-900/30">
          Free Assessment
        </a>
  ...
  <div id="mobile-menu" class="hidden lg:hidden flex-col gap-1 glass-strong mx-4 mb-4 rounded-2xl px-6 py-6">
    ...
    <a href="contact.php" class="mt-4 inline-flex items-center justify-center gap-2 rounded-full bg-gradient-to-r from-amber-600 to-amber-500 px-6 py-3 text-sm font-semibold text-white">
      Free Assessment
    </a>
  </div>
</header>
